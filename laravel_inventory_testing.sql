...
--
-- Database: `laravel_inventory_testing`
--
CREATE DATABASE IF NOT EXISTS `laravel_inventory_testing` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `laravel_inventory_testing`;
